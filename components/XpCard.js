...
const XpCard = () => {
  return (
    <article className='flex flex-col rounded-lg items-center space-y-7 flex-shrink-0 snap-mandatory h-[400px] md:h-full w-[350px] md:w-[600px] xl:w-[900px] snap-center bg-[#292929] p-10 hover:opacity-100 opacity-50 cursor-pointer transition-opacity duration-200 overflow-hidden xl:h-[38rem] '>
        <motion.img 
        initial={{
            y: -100,
            opacity: 0,
        ...
        src="https://cdn.shopify.com/s/files/1/0274/1351/2301/files/SkullGraphicSpinningsmall.gif?v=1627671973" alt="" className='rounded-full h-20 w-20 md:h-32  md:w-32 xl:w-[200px] xl:h-[200px] object-cover object-center' />

        <div className='px-0 md:px-10'>
            <h4 className='text-2xl md:text-4xl font-light -mt-5 md:mt-0 '>Lead Developer</h4>
            ...
            <p className='uppercase py-5 text-gray-400 text-xs md:text-base -mt-5 md:mt-0 '>Started work: 10.02.20 - <span className='italic'>Current</span></p>
            <ul className='list-disc space-y-0 md:space-y-4 ml-5 pb-5 text-sm md:text-lg -mt-3 md:mt-0'>
