...
const XpCard = () => {
  return (
    <article className='flex flex-col rounded-lg items-center space-y-7 flex-shrink-0 snap-mandatory w-[350px] md:w-[600px] xl:w-[900px] snap-center bg-[#292929] p-10 hover:opacity-100 opacity-50 cursor-pointer transition-opacity duration-200 overflow-hidden xl:h-[38rem] '>
        <motion.img 
        initial={{
            y: -100,
            opacity: 0,
        ...
        <div className='px-0 md:px-10'>
            <h4 className='text-2xl md:text-4xl font-light'>Lead Developer</h4>
            ...
            <p className='uppercase py-5 text-gray-400 text-xs md:text-base'>Started work: 10.02.20 - <span className='italic'>Current</span></p>
            <ul className='list-disc space-y-2 md:space-y-4 ml-5 pb-5 text-sm md:text-lg'>
