...
const WorkExperience = () => {
  return (
    ...
    className='h-[fit-content] py-10 relative flex overflow-hidden flex-col text-left md:flex-row max-w-full px-10 justify-evenly mx-auto items-center'>
        ...
        <div className="w-full mt-16 flex lg:items-center lg:justify-center space-x-5 overflow-x-scroll snap-x snap-mandatory scrollbar-track-gray-400/20 scrollbar-thumb-sky-500/80 xl:overflow-x-hidden ">
            <XpCardThree />
            <XpCard  />
            {/* <XpCardTwo /> */}
        </div>
