...
const Projects = () => {
    ...
    return (
        ...
        className='h-screen relative flex overflow-hidden flex-col text-left md:flex-row max-w-full justify-evenly mx-auto items-center z-0 '>
            ...
            <div className='relative w-full flex overflow-x-scroll overflow-y-hidden snap-x snap-mandatory lg:snap-none lg:items-center -mt-10 z-20 scrollbar scrollbar-thumb-sky-500 scrollbar-track-gray-400/20 '>
                {
                    data.map((project, i) => (
