...
const About = () => {
  return (
    ...
    className='h-[fit-content] pt-10 md:py-20 flex flex-col relative text-center md:text-left md:flex-row max-w-7xl px-10 justify-evenly mx-auto items-center'>
        <h3 className="absolute top-0  uppercase tracking-[20px] text-gray-500 text-2xl">Intro</h3>
        ...
        className=' mt-5 md:mt-0 md:mb-0 flex-shrink-0 w-32 h-32 rounded-full object-cover md:rounded-lg md:w-64 md:h-96 xl:w-[500px] xl:h-[600px] xl:mt-5 object-top '
        />

        <div className='space-y-5  md:-mt-0  px-0 md:px-10 xl:space-y-10'>
