...
const About = () => {
  return (
    ...
    className='h-screen flex flex-col relative text-center md:text-left md:flex-row max-w-7xl px-10 justify-evenly mx-auto items-center'>
        ...
        className='-mb-14 mt-14 md:mt-0 md:mb-0 flex-shrink-0 w-32 h-32 rounded-full object-cover md:rounded-lg md:w-64 md:h-96 xl:w-[500px] xl:h-[600px] xl:mt-5 object-top '
        />

        <div className='space-y-2 px-0 md:px-10 xl:space-y-10'>
            <h4 className='text-4xl font-bold'>A little <span className='underline decoration-sky-500'>introduction</span></h4>
